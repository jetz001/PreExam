            ...
            <div style={{ position:'relative' }} ref={profileRef}>
              ...
              {profileOpen && (
                <div className="hn-dropdown" style={{ right:0, minWidth:210, animation:'profileSlide 0.2s ease both' }}>
                  ...
                  <Link to="/profile/questions" className="hn-drop-link" onClick={() => { setProfileOpen(false); publicService.logActivity?.('BTN_NAV_CLICK', { label: 'คลังข้อสอบส่วนตัว', path: '/profile/questions' }); }}>📁 คลังข้อสอบส่วนตัว</Link>
