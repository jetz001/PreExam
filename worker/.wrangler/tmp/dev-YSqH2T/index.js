    ...
    if (url.pathname.startsWith("/api/")) {
      try {
        ...
        if (url.pathname === "/api/admin/settings") {
          ...
          if (request.method === "GET") {
            try {
              const settings = await firestore2.getDocument("system_config", "general_settings");
...
// .wrangler/tmp/bundle-3FcXix/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-3FcXix/middleware-loader.entry.ts
