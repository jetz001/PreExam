        ...
        if (url.pathname === "/api/news" && request.method === "GET") {
          try {
            ...
            if (agency && agency !== "undefined") {
              filteredNews = filteredNews.filter((n) => n.agency === agency || n.metadata && n.metadata.organization === agency);
            }
            if (search && search !== "undefined") {
          ...
          const runScraper = /* @__PURE__ */ __name(async () => {
            try {
              ...
              for (const item of jsonResponse) {
                parsedJobs.push({
                  id: item.id,
                  category: item.jobCategoryId === 1 ? "\u0E02\u0E49\u0E32\u0E23\u0E32\u0E0A\u0E01\u0E32\u0E23\u0E1E\u0E25\u0E40\u0E23\u0E37\u0E2D\u0E19" : "\u0E07\u0E32\u0E19\u0E23\u0E32\u0E0A\u0E01\u0E32\u0E23",
