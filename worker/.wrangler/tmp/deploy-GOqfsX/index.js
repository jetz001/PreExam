        ...
        if (url.pathname === "/api/news" && request.method === "GET") {
          try {
            ...
            if (ministry && ministry !== "undefined") {
              filteredNews = filteredNews.filter((n) => n.metadata && n.metadata.ministry === ministry);
            }
            if (agency && agency !== "undefined") {
              filteredNews = filteredNews.filter((n) => n.agency === agency || n.metadata && n.metadata.organization === agency || n.metadata && n.metadata.department === agency);
            }
            if (search && search !== "undefined") {
